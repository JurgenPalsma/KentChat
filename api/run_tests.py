...
def main(sdk_path, test_path, test_pattern):
    ...
    suite = unittest.loader.TestLoader().discover(test_path, pattern=test_pattern)
    print(test_path, test_pattern, suite)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--test-path',
        help='The path to look for tests, defaults to the directory named "tests".',
